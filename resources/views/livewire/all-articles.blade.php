...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <h2 class="text-2xl font-bold md:text-4xl md:leading-tight ">Find More Health Informations</h2>
    <p class="mt-1 text-gray-600 ">Lire des articles.</p>
  </div>
  <!-- End Title -->
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <a class="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg transition-all duration-300 rounded-xl p-5 " href="#">
      ...
      <div class="my-6">
        ...
        Annonce d'un plan gratuit pour les petites équipes
        </h3>
  ...
  <div class="mt-12 text-center">
    <a class="py-3 px-4 inline-flex items-center gap-x-1 text-sm font-medium rounded-full border border-gray-200 bg-white text-blue-600 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none " href="#">
      Read more
