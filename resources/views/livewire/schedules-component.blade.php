              ...
              @if (count($schedules) > 0)
                  @foreach ($schedules as $item)
                       <tr >
                        ...
                        <td class="h-px w-auto whitespace-nowrap">
                          <div class="px-6 py-2">
                            <span class="text-sm text-gray-800 ">{{ $daysOfweek[$item->available_day] }}</span>
                          </div>
                        </td>
                         <td class="h-px w-auto whitespace-nowrap">
                          <div class="px-6 py-2">
                            <span class="text-sm text-gray-800 ">{{ $item->from }}</span>
                          </div>
                        </td>
                         <td class="h-px w-auto whitespace-nowrap">
                          <div class="px-6 py-2">
                            <span class="text-sm text-gray-800 ">{{ $item->to }}</span>
                          </div>
                        </td>
                        <td class="h-px w-auto whitespace-nowrap">
