...
class BookingComponent extends Component
{
    ...
    public function bookAppointment($slot){
        ...
        $appointmentEmailData = [
            ...
            'appointment_type' => $this->appointment_type == 0 ? 'sur place' : 'consultation en direct',
        ...
        session()->flash('message','Rendez-vous avec le Dr.'.$this->doctor_details->doctorUser->name.' le '.$this->selectedDate.$slot.' a été créé !');
    ...
    public function sendAppointmentNotification($appointmentData)
    {
        ...
        Mail::to('cura00229@gmail.com')->send(new AppointmentCreated($appointmentData));
